...
function mostrar()
{
	...
	for(contadorProducto = 0; contadorProducto < 2; contadorProducto++) {
		...
		//PUNTO A) SIN RESOLVER
		/*if(tipoProducto == "barbijo" && banderaBarbijo == 0 || barbijoPrecioMax < precioProducto) 
		{
			barbijoPrecioMax = precioProducto;
        ...
        } else if (tipoProducto > barbijoProductoMax) {
            barbijoProductoMax = tipoProducto;
			barbijoCantidadUnidadesMax = cantidadUnidadesProducto;
			barbijoFabricanteMax = fabricanteProducto;
        }*/
